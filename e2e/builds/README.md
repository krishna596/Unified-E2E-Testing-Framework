...
- **Android:** `e2e/builds/debug-26.4.10-426020733.apk` (or update the path in `wdio.conf.ts` to match your APK)
- **iOS:** `e2e/builds/Bestbuy-mApp.app/` (simulator `.app` bundle)
