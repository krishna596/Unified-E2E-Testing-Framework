...
// App paths
const androidApp = path.join(__dirname, 'e2e/builds/debug-26.4.10-426020733.apk');
const iosApp = path.join(__dirname, 'e2e/builds/Bestbuy-mApp.app');
...
const androidCapabilities: WebdriverIO.Capabilities = {
  ...
  'appium:appPackage': 'com.bestbuy.android.debug',
  'appium:appActivity': 'com.bestbuy.android.activity.SplashActivity',
...
const iosCapabilities: WebdriverIO.Capabilities = {
  ...
  'appium:app': iosApp,
  'appium:bundleId': 'com.bestbuy.buyphone.production',
  'appium:autoAcceptAlerts': true,
  'appium:newCommandTimeout': 240,
  'appium:noReset': true,
  // Use prebuilt WDA - critical for Xcode 16+ compatibility
  'appium:usePrebuiltWDA': true,
  'appium:derivedDataPath': `${require('os').homedir()}/Library/Developer/Xcode/DerivedData/WebDriverAgent-gcdlwuhtejdrmxfszeywojxanxpr`,
...
export const config: Options.Testrunner = {
  ...
  // ==================
  specs: [
    './e2e/specs/**/price.spec.ts',   // Same spec file for all platforms!
  ],
  exclude: [],
